object frmItemC: TfrmItemC
  Left = 302
  Top = 172
  BorderStyle = bsDialog
  Caption = 'Relat'#243'rio de Mercadorias'
  ClientHeight = 151
  ClientWidth = 311
  Color = clBtnFace
  ...
  object Label3: TLabel
    ...
    Height = 26
    Alignment = taCenter
    Caption = 'Mercadorias '#13#10'cadastradas no per'#237'odo'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
