...
//      UpdCodigo('DESPESAS', strtoint(edtCodigo.text));
      ApagaMovimento('Despesas','DÉBITO',1,StrToIntDef(edtCodigo.text, 0));
      GeraMovimentacao(edtCadastro.date, 'Despesas','DÉBITO',edtValor.Value, 1 ,strtoint(edtCodigo.text));
      result := true;
    end;
  end
...
begin
  ...
  begin
    Exclusao2('Você pode apenas fazer despesas com o caixa aberto.','Aviso');
    Close;
  end;
